...
const suggestions = [
  {id: "draft-email", label: "Draft an email", icon: "solar:document-add-outline"},
  {id: "create-image", label: "Create an image", icon: "solar:gallery-linear"},
  ...
  {id: "get-advice", label: "Get advice", icon: "solar:square-academic-cap-2-outline"},
];
